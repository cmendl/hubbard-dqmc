...
double Determinant(const int n, const double *restrict A)
{
	...
	double *LU = MKL_malloc(n*n * sizeof(double), MEM_DATA_ALIGN);
	__assume_aligned(LU, MEM_DATA_ALIGN);
	...
	LAPACKE_dgetrf(LAPACK_COL_MAJOR, n, n, LU, n, ipiv);
...
//________________________________________________________________________________________________________________________
///
/// \brief Compute the sign of the matrix determinant
///
